        ...
        <div className="container max-w-7xl mx-auto px-8 lg:px-16 relative z-10">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.08)] md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-[#0F172A] mb-4">Proactive Maintenance Approach</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  We don't just fix issues when they occur - we prevent them from happening in the first place.
                </p>
                <div className="space-y-5 mb-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1 mr-3 w-6 h-6 rounded-full bg-[#E7107E]/20 flex items-center justify-center text-[#E7107E]">✓</div>
                    <div>
                      <h4 className="text-[#E7107E] font-medium">Regular Security Updates</h4>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1 mr-3 w-6 h-6 rounded-full bg-[#E7107E]/20 flex items-center justify-center text-[#E7107E]">✓</div>
                    <div>
                      <h4 className="text-[#E7107E] font-medium">Scheduled Backups</h4>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mt-1 mr-3 w-6 h-6 rounded-full bg-[#E7107E]/20 flex items-center justify-center text-[#E7107E]">✓</div>
                    <div>
                      <h4 className="text-[#E7107E] font-medium">Performance Monitoring</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
                <h3 className="text-xl font-semibold mb-3 text-[#E7107E]">Security Protection</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
                <h3 className="text-xl font-semibold mb-3 text-[#E7107E]">Performance Optimization</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
                <h3 className="text-xl font-semibold mb-3 text-[#E7107E]">Prevent Downtime</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="relative">
              <div className="relative rounded-xl overflow-hidden shadow-2xl border border-[#E7107E]/20">
                <img
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  <div className="flex items-center">
                    <Shield className="w-8 h-8 text-[#E7107E] mr-3" />
                    <div>
                      <h4 className="text-[#E7107E] font-semibold">Proactive Protection</h4>
